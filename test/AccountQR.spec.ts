...
import { AccountQR, QRCodeType } from '../index';
  ...
  describe('with password -->', () => {
    ...
    describe('fromJSON() should', () => {
      ...
      it('throw error given wrong password', () => {
        ...
        // Act + Assert
        expect(() => {
          const importAccount = AccountQR.fromJSON(
            exportAccount.toJSON(),
            'wrong-password'
          );
      ...
      it('reconstruct account given correct password', () => {
        ...
        // Assert
        expect(importAccount.accountPrivateKey).to.be.equal(
          exportAccount.accountPrivateKey
        );
      });
      ...
      it('reconstruct account given correct ciphertext and password', () => {
        ...
        // Assert
        expect(importAccount.accountPrivateKey).to.be.equal(
          '749F1FF1972CD465CAB74566FF0AA021F846FBE3916ABB6A6C1373E962C76331'
        );
        expect(
          ...
          '50BFEB16AA0A3E00B8AB9385A2686991A09522DCDA4AC31B400BB5674EE4CDF8'
        );
      });
    });
  });
