...
describe('QRCodeGenerator -->', () => {
  ...
  describe('fromJSON() should', () => {
    ...
    it('Populate mnemonic pass phrase given MnemonicQR JSON', () => {
      ...
      // create mnemonic validation (simplified without MnemonicPassPhrase)
      const words = mnemonicObj.mnemonicPlainText.split(' ');
      if (words.length !== 24) {
        throw new Error('Invalid mnemonic pass phrase - must be 24 words.');
      }
